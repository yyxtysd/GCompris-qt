...
var treeStructure = [
                    ...
                    {  edgeList: [
                               ...
                               [0.39, 0.17, 0.43, 0.17],
                               [0.37, 0.19, 0.37, 0.40],
                               [0.44, 0.45, 0.520, 0.45],
                               [0.54, 0.45, 0.60, 0.45],
                               [0.525, 0.47, 0.525, 0.65],
                               [0.33, 0.65, 0.70, 0.65],
                               [0.33, 0.65, 0.33, 0.70],
                      ...
                      edgeState:["others","others","others","others","others","others","others","others","others","others" ],
                   ...
                   {  edgeList: [
                     ...
                     nodePositions: [
                      ...
                      weddingringpositions: [ [0.350,0.16],
                                              [0.515,0.43]
                      ],
                   ...
                   {  edgeList: [
                    ...
                    edgeState:["others","others","others","others","others","others","others"],
                    answer: [qsTr("Aunt")],
                    optionss: [qsTr("Uncle"), qsTr("Aunt"), qsTr("Nephew"), qsTr("Niece")]
                   },
                   // level 12
                   {  edgeList: [
                     ...
                     weddingringpositions: [[0.49,0.16]],
                     nodeleave: ["grandfather.svg", "old-lady.svg", "man3.svg", "lady1.svg", "babyboy.svg"],
                   ...
                   // level 13
                   {  edgeList: [
                           [0.65, 0.16, 0.685, 0.16],
                           [0.72, 0.16, 0.76, 0.16],
                           [0.71, 0.19, 0.71, 0.70],
                           [0.70, 0.50, 0.62, 0.50],
                           [0.46, 0.52, 0.41, 0.52],
                           [0.38, 0.52, 0.33, 0.52],
                           [0.705, 0.695, 0.76, 0.695]
                     ],
                     nodePositions: [
                          [0.463, 0.10],
                          [0.75, 0.10],
                   ...
                   {  edgeList: [
                            [0.52, 0.16, 0.56, 0.16],
                            [0.595, 0.16, 0.65, 0.16],
                            [0.58, 0.19, 0.58, 0.70],
                            [0.58, 0.50, 0.475, 0.50],
                            [0.310, 0.52, 0.275, 0.52],
                            [0.25, 0.52, 0.205, 0.52],
                            [0.57, 0.695, 0.63, 0.695],
                            [0.615, 0.75, 0.57, 0.75],
                            [0.55, 0.75, 0.49, 0.75]
                    ],
                    nodePositions: [
                            [0.33, 0.10],
                    ...
                    edgeState:["others","others","others","others","others","others","others","others","others"],
...
function initLevel() {
    ...
    items.weddingringcreator.model.clear();
    ...
    for(var l =0; l< levelTree.weddingringpositions.length ; l++){
        items.weddingringcreator.model.append({
                "ringx":levelTree.weddingringpositions[l][0],
                "ringy":levelTree.weddingringpositions[l][1],
